...
export default function DiscoverPage({
  ...
  onOpen, onSetStatus, onFindPeople,
}) {
  ...
  if (searchResults) return (
    <div>
      ...
      {searchResults.length ? (
        <CardGrid items={searchResults} library={library} onOpen={onOpen} onSetStatus={onSetStatus} />
      ) : (
  ...
  return (
    <div>
      <div className={styles.section}>
        ...
        <CardGrid items={trending.movies} library={library} onOpen={onOpen} onSetStatus={onSetStatus} />
      </div>
      <div className={styles.section}>
        <div className={styles.sectionHeader}><Tv size={24} className={styles.sectionIcon} /> Trending TV shows this week</div>
        <CardGrid items={trending.tv} library={library} onOpen={onOpen} onSetStatus={onSetStatus} />
      </div>
    </div>
  )
}
