...
export default function ResetPassword({ onDone }) {
  ...
  useEffect(() => {
    // Supabase sets a session from the reset link hash
  ...
  if (done) return (
    <div style={Wrap}>
      <div style={Card}>
        ...
        <p style={P}>Your password has been changed successfully. You can now sign in with your new password.</p>
  ...
  if (!validSession) return (
    <div style={Wrap}>
      <div style={Card}>
        ...
        <h2 style={H2}>Invalid or expired link</h2>
        <p style={P}>This password reset link has expired or already been used. Request a new one.</p>
  ...
  return (
    <div style={Wrap}>
      <div style={Card}>
        ...
        <p style={P}>Choose a strong password for your account.</p>
        ...
        <div style={{ marginBottom: 14 }}>
          ...
          <div style={{ position: 'relative' }}>
            <input type={showPw ? 'text' : 'password'} value={password}
              ...
              autoFocus style={{ ...I, paddingRight: 44 }} />
            <button onClick={() => setShowPw(v => !v)} style={EyeBtn} title={showPw ? 'Hide' : 'Show'}>
              {showPw ? '🙈' : '👁️'}
            </button>
          </div>
        </div>
        ...
        <div style={{ marginBottom: 14 }}>
          ...
          <input type={showPw ? 'text' : 'password'} value={confirm}
            ...
            placeholder="Confirm password" style={I} />
        </div>
